...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full space-y-[1vw] xl:space-y-[2vh] ">

      <Header user={user} title="Dashboard" subtitle="Stato di corsi, studenti e attività" />

      <div className='grid grid-cols-2 xl:grid-cols-4 gap-[1rem] shrink-0'>
        {/* Card Informative */}
        <Card
          ...
          subtitle={
            <>
              <span className={parseInt(v('studentiIncrement')) > 0 ? 'text-green-600' : 'text-red-600'}>
                {v('studentiIncrement')}
              </span> vs Anno scorso
            </>
          }
      ...
      <div className='xl:grid xl:grid-cols-12 xl:gap-[1vw] xl:flex-1 flex-col space-y-[1vw] xl:space-y-[0] min-h-0'>
            ...
            <div className='flex justify-between items-center xl:grid xl:grid-cols-2 gap-[1vw]'>
              ...
              <Button
                ...
                icon={<SvgIcon
                  ...
                  width="2.5vh"
                  height="2.5vh"
                  path1='M18.5261 2.05649C17.1467 1.98117 15.9021 1.98117 14.5227 2.05649C13.8851 2.09131 13.3585 2.58261 13.2605 3.23388C13.1648 3.87098 13.1337 4.47502 13.1675 5.0907C13.1654 5.12109 13.1644 5.15175 13.1644 5.18266V9.28404C10.8658 9.79282 8.86557 11.6613 8.72618 14.9083C8.71809 15.0402 8.71032 15.1711 8.70286 15.3011V26.9441C10.0029 26.9727 11.3513 26.9914 12.7144 27L12.7142 26.9754V23.2839C12.7142 22.2977 13.5137 21.4982 14.5 21.4982C15.4862 21.4982 16.2857 22.2977 16.2857 23.2839V26.9754L16.2855 27C17.6486 26.9914 18.997 26.9727 20.297 26.9441V15.2042L20.28 14.919C20.1421 11.7039 18.1419 9.82309 15.843 9.29536V7.21502C16.7311 7.23252 17.5981 7.21595 18.5261 7.16527C19.1637 7.13045 19.6904 6.63914 19.7883 5.98788C19.93 5.04579 19.93 4.17598 19.7883 3.23388C19.6904 2.58261 19.1637 2.09131 18.5261 2.05649ZM22.5291 15.7445V26.8836C23.1082 26.8646 23.6723 26.8434 24.2177 26.8202C25.5457 26.7632 26.6009 25.6814 26.7655 24.307C26.9179 23.0355 27 22.1782 27 21.3082C27 20.438 26.9179 19.5808 26.7655 18.3094C26.6009 16.935 25.5457 15.8531 24.2177 15.7962C23.783 15.7776 23.177 15.7604 22.5291 15.7445ZM6.47071 26.8836V15.7446C5.82248 15.7604 5.21639 15.7776 4.78227 15.7962C3.45436 15.8531 2.39909 16.935 2.23448 18.3094C2.08222 19.5808 2 20.438 2 21.3082C2 22.1782 2.08222 23.0355 2.23448 24.307C2.39909 25.6814 3.45436 26.7632 4.78227 26.8202C5.3277 26.8434 5.89168 26.8646 6.47071 26.8836ZM14.5 17.5117C15.7595 17.5117 16.468 16.7804 16.468 15.4803C16.468 14.1802 15.7595 13.4489 14.5 13.4489C13.2405 13.4489 12.532 14.1802 12.532 15.4803C12.532 16.7804 13.2405 17.5117 14.5 17.5117Z'
        ...
        <div className='xl:col-span-8 flex flex-col gap-[1vw] h-full xl:overflow-hidden overflow-auto order-2 xl:order-1'>
          <Container title="Andamento Iscrizioni" className="h-[50%] xl:h-[35vh] shrink-0">
            <TrendGraph key={`${refreshKey}`} />
          </Container>
          <div className='xl:grid xl:grid-cols-9 xl:gap-[1vw] xl:flex-1 flex flex-col space-y-[1vw] xl:space-y-[0] min-h-0 mb-[1vw] xl:mb-[0] xl:h-full overflow-hidden'>
            <Container title="Avanzamento Corsi" className="xl:col-span-6 flex flex-col overflow-hidden">
