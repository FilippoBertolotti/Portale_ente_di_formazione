...
const Aule = () => {
    ...
    useEffect(() => {
        ...
        const fetchRiepilogo = async () => {
            if (selectedSede) {
                try {
                    const infSede = await auleService.getSedeByNome(selectedSede);
                ...
                loading ? (
                    ...
                    <div className='grid grid-cols-12 gap-[1vw] flex-1 min-h-0'>
                        ...
                        <div className='col-span-3 h-full flex flex-col gap-[1vw] overflow-hidden'>
                            ...
                            <Container title={selectedSede ? `Infromazioni ${selectedSede}` : 'Informazioni Aggiuntive'} className=" h-full overflow-hidden">
