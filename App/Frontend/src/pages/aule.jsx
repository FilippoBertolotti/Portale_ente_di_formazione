                ...
                loading ? (
                    ...
                    <div className='grid grid-cols-12 gap-[2vh] flex-1 min-h-0'>
                        ...
                        <div className='col-span-3 h-full flex flex-col gap-[2vh] overflow-hidden'>
                            ...
                            <Container title='Riepilogo Anno ' className=" h-full overflow-hidden">
                                <div className=' flex flex-col space-y-[2vh] h-full overflow-hidden'>
                                    <div className='text-black text-lg font-bold'><span className="text-sm font-normal whitespace-nowrap">Coordinatore: </span>{'...'}</div>
